const mutations = {
  ...
  // setCurrentActivity(state, activityNum) {
  //   console.log("存储的活动列表", state.activityList);
  //   if (state.activityList.length > 0) {
  //     state.currentActivity = state.activityList.find(
  //       todo => todo.activity_num === activityNum
  //     )[0];
